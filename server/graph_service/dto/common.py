...
class Message(BaseModel):
    ...
    name: str | None = Field(
        default=None, description='The name of the episodic node for the message (optional)'
    )
    role_type: Literal['user', 'assistant', 'system'] | None = Field(
        default=None, description='The role type of the message (user, assistant or system)'
    )
    role: str | None = Field(
        default=None,
    ...
    source_description: str | None = Field(
        default=None, description='The description of the source of the message'
    )
